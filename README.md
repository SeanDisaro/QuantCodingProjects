...
<!-- BulletPointStart -->
- NVIDIA will report Q1 FY2027 results and hold a May 20 conference call; CFO Colette Kress will provide prepared remarks, with a live webcast and a replay available; the company is described as a world leader in AI and accelerated computing.

- AWS CEO Andy Jassy says Nvidia remains a core partner for AI workloads, with Trainium, Graviton, and Nvidia GPUs powering AWS; AWS will continue to place substantial orders and values offering customers choice.

- Nvidia’s capex jumped about 87% year over year to $6.04 billion, and the company is aiming to reach at least $1 trillion in revenue by 2027, driven by demand for Blackwell and Vera Rubin data center systems.

- Analysts view Nvidia positively, with TipRanks noting a Strong Buy rating and roughly 23.9% upside potential.

- Nvidia is active in the options market, showing notable NVDA-related activity including large weekly call trades and substantial overall option volume, signaling strong investor interest. 
