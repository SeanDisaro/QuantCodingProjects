...
<!-- BulletPointStart -->
- AI capex tailwinds from hyperscalers set up Nvidia for another strong quarter, with a medium- to long-term upside potential cited around 12–24 months of roughly 65% by one bullish investor. 

- Wall Street remains very bullish: a Strong Buy consensus (dozens of buys vs. few holds/sells) with an average target near $260.38, implying about 42% upside from current levels.

- Nvidia is a top holding in major tech ETFs (BCTK and FDTX), underscoring broad investor demand for Nvidia exposure; these ETFs show notable upside potential (BCTK ~36% and FDTX ~30% to target).

- The stock has shown relative resilience within the Magnificent 7, with Nvidia down only about 2% in early 2026, outperforming peers during a broader AI/tech drawdown.

- Competitive risk is rising: AMD is gaining share in AI inference (roughly 20–25% of new AI chip setups) and is advancing with initiatives like the AMD Helios platform and India deal, signaling Nvidia’s dominance isn’t guaranteed and providing a potential upside case for rivals (AMD target around 286.80 with ~38% upside). 
