...
<!-- BulletPointStart -->
- NVIDIA Q3 FY2026 results: revenue of $57.0 billion (up 22% QoQ, up 62% YoY); GAAP and non-GAAP gross margins around 73.4–73.6%; diluted EPS of $1.30. 
- AI computing demand remains ultra-strong: CEO Jensen Huang cites “Blackwell” sales, cloud GPUs sold out, and a virtuous cycle of accelerating compute demand across training and inference.
- Strong capital return and balance sheet activity: $37.0 billion returned to shareholders in the first nine months of FY2026 via buybacks and dividends; $62.2 billion remaining under share repurchase authorization.
- Dividend slated: NVIDIA will pay a quarterly cash dividend of $0.01 per share on December 26, 2025 (record date December 4, 2025).
- Large-scale AI infrastructure partnerships highlight NVIDIA’s role in expanding compute: AWS and Humain plan to deploy up to 150,000 accelerators, including NVIDIA GB300 GPUs, in a Riyadh-based AI Zone, signaling major global AI compute expansion and a new commercial model. 
